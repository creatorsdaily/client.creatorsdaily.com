...
ENV NEXT_PUBLIC_API=$NEXT_PUBLIC_API \
  NEXT_PUBLIC_GRAPHQL=$NEXT_PUBLIC_GRAPHQL \
  NEXT_PUBLIC_GRAPHQL_WS=$NEXT_PUBLIC_GRAPHQL_WS \
  NEXT_PUBLIC_UPLOAD=$NEXT_PUBLIC_UPLOAD \
  NEXT_PUBLIC_FILES=$NEXT_PUBLIC_FILES \
  NEXT_PUBLIC_PARSER=$NEXT_PUBLIC_PARSER \
  NEXT_PUBLIC_INDEX=$NEXT_PUBLIC_INDEX \
  NEXT_PUBLIC_NAME=$NEXT_PUBLIC_NAME \
  NEXT_PUBLIC_SLOGAN=$NEXT_PUBLIC_SLOGAN \
  ...
  NEXT_PUBLIC_BAIDU_TONGJI=$NEXT_PUBLIC_BAIDU_TONGJI \
  NEXT_PUBLIC_CLOSE_TIP=$NEXT_PUBLIC_CLOSE_TIP
WORKDIR /app
RUN yarn
COPY . .
